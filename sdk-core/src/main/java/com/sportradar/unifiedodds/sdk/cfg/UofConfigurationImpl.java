...
public class UofConfigurationImpl implements UofConfiguration {
    ...
    private UofApiConfigurationImpl apiConfiguration;
    private UofRabbitConfigurationImpl rabbitConfiguration;
    private UofCacheConfigurationImpl cacheConfiguration;
    private UofProducerConfigurationImpl producerConfiguration;
    private UofAdditionalConfigurationImpl additionalConfiguration;
    private Function<UofConfiguration, WhoAmIReader> buildWhoAmIReader;
    private Function<UofConfiguration, ProducerDataProvider> buildProducerDataProvider;
    ...
    public void updateSdkEnvironment(Environment env) {
        if (
            ...
            if (environment != Environment.Custom) {
                ...
                com.testinzone.unifiedodds.sdk.impl.EnvironmentSetting envSetting =
    ...
    public void checkAndUpdateConnectionSettings() {
        ...
        if (environment != Environment.Custom) {
            ...
            com.testinzone.unifiedodds.sdk.impl.EnvironmentSetting mqSetting =
                EnvironmentManager.getSetting(environment);

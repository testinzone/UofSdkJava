...
public final class EnvironmentManager {
        ...
        environmentSettings =
            Lists.newArrayList(
                ...
                new EnvironmentSetting(
                    ...
                    "mq.ap-southeast-1.betradar.com",
                    "api.ap-southeast-1.betradar.com",
                    80,
                    true,
                    basicRetryList
                ),
                new EnvironmentSetting(
                    ...
                    "mq.ap-northeast-1.betradar.com",
                    "api.ap-northeast-1.betradar.com",
                    80,
                    true,
                    basicRetryList
                )
    ...
    public static EnvironmentSetting getSetting(Environment environment) {
        EnvironmentSetting setting = environmentSettings
            .stream()

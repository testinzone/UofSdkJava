...
public class UofProducerConfigurationTests {
    ...
    public void defaultImplementationUsesDefaultValues() {
        Assert.assertTrue(config.adjustAfterAge());
        Assert.assertEquals(
    ...
    @Test
    public void setAdjustAfterAge_ValidValue() {
        final boolean newValue = false;
        config.setAdjustAfterAge(newValue);

        Assert.assertEquals(newValue, config.adjustAfterAge());
    }
    ...
    public void toStringHasAllTheValues() {
        ...
        Assert.assertTrue(summary.contains("adjustAfterAge="));

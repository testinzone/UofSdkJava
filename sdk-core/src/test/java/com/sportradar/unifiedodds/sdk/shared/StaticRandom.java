...
public class StaticRandom {
    ...
    public static long L(long limit) {
    ...
    public static double D(int limit) {
    ...
    public static String S10000() {
        return S(10000);
    }

    public static String S10000P() {
        return S(900000000) + 100000;
    }

    public static int I1000() {
        return I(1000);
    }
    ...
    public static int getId(int id) {
        return getId(id, I1000());
    }

    public static int getId(int id, int newId) {
        return id == 0 ? newId : id;
    }
}

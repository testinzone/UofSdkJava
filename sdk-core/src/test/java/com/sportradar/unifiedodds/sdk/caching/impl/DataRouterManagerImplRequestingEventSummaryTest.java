...
public class DataRouterManagerImplRequestingEventSummaryTest {
    ...
    public void providerFailureShouldResultInExceptionExplainingThat() throws DataProviderException {
        ...
        CommunicationException exception = catchThrowableOfType(
            () -> manager.requestSummaryEndpoint(china, id, ANY_CACHE_ITEM),
            CommunicationException.class
        );

        assertEquals(
            "Error executing summary request for id=" + id + ", locale=" + china,

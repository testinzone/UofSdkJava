...
public final class ExampleReplayEvents {
    ...
    public static final List<SampleEvent> SAMPLE_EVENTS = ImmutableList
        .<SampleEvent>builder()
        ...
        .add(
            event(
                "Basketball Match - NBA Final 2017 - (Golden State Warriors vs Cleveland Cavaliers)",
                "sr:match:11733773"
            )
        )
        ...
        .add(
            event(
                "Icehockey Match - NHL Final 2017 (6th match - (Nashville Predators vs Pittsburg Penguins)",
                "sr:match:11784628"
            )
        )
        ...
        .add(
            event(
                "Icehockey Match with overtime + rollback_bet_cancel + match_status=\"aet\"",
                "sr:match:11878386"
            )
        )
        .add(
            event(
                "American Football Game - NFL 2018/2018 (Chicago Bears vs Atlanta Falcons)",
                "sr:match:11538563"
            )
        )
        ...
        .add(
            event(
                "Handball Match - DHB Pokal 17/18 (SG Flensburg-Handewitt vs Fuchse Berlin)",
                "sr:match:12362564"
            )
        )
        .add(
            event(
                "Baseball Game - MLB 2017 (Final Los Angeles Dodgers vs Houston Astros)",
                "sr:match:12906380"
            )
        )
        .add(event("Badminton Game - Indonesia Masters 2018", "sr:match:13600687"))
        .add(
            event("Snooker - International Championship 2017 (Final Best-of-19 frames)", "sr:match:12927314")
        )
        ...
        .add(
            event(
                "Cricket Match [Premium Cricket] - The Ashes 2017 (Australia vs England)",
                "sr:match:11836360"
            )
        )
        .add(
        ...
        .add(
            event(
                "Volleyball match where Betradar loses coverage mid-match - no ability to verify results",
                "sr:match:13582831"
            )
        )
        ...
        .add(
            event(
                "Golf Winner Events + Three Balls - South African Open (Winner events + Three balls)",
